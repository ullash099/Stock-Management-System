...
export default function PendingDelivery(props) {
    const [appLink,setApplink] = React.useState(AppUrl(`/secure/sales/get-pending-delivery-invoices?`))
                ...
                <Col>
                    <Card>
                        <Card.Header className="bg-secondary text-white">
                            <Card.Title>Pending Delivery Invoice List</Card.Title>
                        </Card.Header>
                                                            ...
                                                            <tr key={index}>
                                                                ...
                                                                <td className="align-middle">
                                                                    <DropdownButton title="Action" className="btn-sm float-end">
                                                                        <Link className='dropdown-item' to={AppUrl(`/control/delivery/delivery-invoice/`+info.invoice)}>
                                                                            Delivery
                                                                        </Link>
                                                                    </DropdownButton>
                                                                </td>
