...
export default function Customers(props) {
    const [appLink,setApplink] = React.useState(AppUrl(`/secure/get-customers?`))
    ...
    const handelEditWork = (obj) => {
        setFormData({
            ...
            customer_address : obj.customer_address ? obj.customer_address : ``,
        ...
        if(id){
            ...
            .then(async (result) => {
                if (result.isConfirmed) {
                    const data = new FormData()
                    data.append('id', id)
                    await axios.post(AppUrl(`/secure/unblock-customer`),data)
                    .then(function (response) {
                        let info = response.data;
        ...
        if(blockItems.length > 0){
            ...
            .then(async (result) => {
                if (result.isConfirmed) {
                    ...
                    await axios.post(AppUrl(`/secure/block-customers`),data)
                    .then(function (response) {
                        let info = response.data;
                        if(info.errors){
                            (info.errors).map((error)=>(
                ...
                <Col>
                    <Card>
                        <Card.Header className="bg-secondary text-white">
                            <Card.Title className='d-inline'>Customers List</Card.Title>
                        ...
                        <Card.Body>
                            ...
                            <Row className="mb-2">
                                ...
                                <Col md={4} sm={12}>
                                    ...
                                    <Link to={AppUrl(`/secure/export-customers`)} target="_blank" className="btn btn-success float-end">
