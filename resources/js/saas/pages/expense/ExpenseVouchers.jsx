...
export default function ExpenseVouchers(props) {
    const [appLink,setApplink] = React.useState(AppUrl(`/secure/expense/get-expense-vouchers?`))
                ...
                <Col>
                    <Card>
                        <Card.Header className="bg-secondary text-white">
                            <Card.Title>Expense Voucher List</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            <Row className="mb-2">
                                                            ...
                                                            <tr key={index}>
                                                                ...
                                                                <td className="align-middle">
                                                                    <DropdownButton title="Action" className="btn-sm float-end">
                                                                        <Link className='dropdown-item' to={AppUrl(`/control/expense/expense-voucher-details/`+info.voucher)}>
                                                                            Details
                                                                        </Link>
