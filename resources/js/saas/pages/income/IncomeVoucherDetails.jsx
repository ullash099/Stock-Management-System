...
export default function IncomeVoucherDetails(props) {
    ...
    const handelGetVoucherInfo = async (voucher) => {
        ...
        await axios.post(AppUrl(`/secure/income/get-income-voucher-details`),formData)
        .then(function (response) {
            ...
            setData({
                ...
                footer_note : info.income_voucher_footer_note  ? info.income_voucher_footer_note : `` ,
            ...
            if (result.isConfirmed) {
                ...
                .then(function (response) {
                    ...
                    if(info.errors){
                        ...
                        props.history.push(AppUrl(`/control/income/income-vouchers`))
                    } 
                })
                .catch(function (error) {
                    if(error == 'Error: Request failed with status code 401'){
        ...
        <React.Fragment>
            <Row>
                <Col>
                    <Card>
                        <Card.Header>
                            <Link to={AppUrl('/control/income/income-vouchers')} 
