...
class GenerateSalesReportController extends Controller
{
    private $report;
    ...
    {
        return $this->report->SalesReport($request->startData,$request->endData);
    }
    ...
    public function print()
    {
        ...
        $data = $this->report->SalesReport($startData,$endData);
